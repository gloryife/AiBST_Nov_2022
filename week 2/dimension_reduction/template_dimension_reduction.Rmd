...
```{r}
pca <- c("pc1", "pc2", "pc3", "pc4")
variance_dataframe <- data.frame(explained_variance_ratio, pca)
head(variance_dataframe)
```

```{r}
ggplot(variance_dataframe, aes(x = pca, y = explained_variance_ratio)) +
  geom_col()
...
cowplot::plot_grid(plot_complete, plot_average, plot_single, plot_ward)
