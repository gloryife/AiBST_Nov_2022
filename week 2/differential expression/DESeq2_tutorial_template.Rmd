...
corr_matrix_dds <- cor(assay(rlog_transformed_dds), method = "spearman")

# use pheatmap to plot the correlation matrix 
pheatmap(corr_matrix_dds)
```
...
corr_matrix_dds_subset <- cor(assay(rlog_transformed_dds_subset), method = "spearman")

pheatmap(corr_matrix_dds_subset)
